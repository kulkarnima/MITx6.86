...
# print('softmax test_error_pca=', test_error_pca)
...
# print('softmax test_error_cube=', test_error_cube)

# print('---- predicting with cubic SVC ----')
# clf = SVC(random_state=0, kernel="poly", degree=3).fit(train_pca10, train_y)
# test_y_poly = clf.predict(test_pca10)
# test_error_poly = 1 - np.mean(test_y_poly == test_y)
# print('softmax test_error_sucib_svm=', test_error_poly)

print('---- predicting with rbf SVC ----')
clf = SVC(random_state=0, kernel="rbf", degree=3).fit(train_pca10, train_y)
test_y_rbf = clf.predict(test_pca10)
test_error_rbf = 1 - np.mean(test_y_rbf == test_y)
print('softmax test_error_rbf_svm=', test_error_rbf)
